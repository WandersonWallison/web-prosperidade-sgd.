    ...
    <form>
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <!--<label>Celular</label>
                <fg-input type="text" v-mask="'(##)#####-####'" name="celular" v-validate="modelValidations.celular" :error="getError('celular')" v-model="model.celular"></fg-input>-->
                <label>E-mail</label>
            ...
            <div class="form-group">
                ...
                <label>Número</label>
                <fg-input type="text" name="numero" v-validate="modelValidations.numero" :error="getError('numero')" v-model="model.numero"></fg-input>
    ...
    mounted() {
        ...
        axios
            ...
            .then(response => {
                ...
                //this.model.celular = this.CentralEdit.celular
                this.model.email = this.CentralEdit.email
                //this.model.site = this.CentralEdit.site
