        ...
        <div class="card-body row">
            ...
            <div class="col-sm-6">
                <div class="card-body text-left">
                    <div>
                        <h5 class="card-title">Tipos de Situações de Movimento </h5>
                    </div>
                </div>
            </div>
            <!-- ------------------------- -->
...
export default {
    ...
    methods: {
        ...
        // ----------------------------------
        handleRegister() {
            this.$router.push('/forms/TipoSituacaoMovimentoForms')
        },
        handleEdit(index, row) {
            window.localStorage.setItem('tipo_situacao_movimento', row.id)
            this.$router.push('/forms/TipoSituacaoMovimentoEdit')
        },
        handleDelete(index, row) {
            ...
            axios.put(process.env.VUE_APP_ROOT_API + '/tipo_situacao_movimento/' + row.id, Tipomovimento)
                .then(response => {
